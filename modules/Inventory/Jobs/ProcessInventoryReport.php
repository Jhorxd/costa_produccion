<?php
    ...
    class ProcessInventoryReport implements ShouldQueue
    {
        ...
        {
            // duplicado en modules\Inventory\Http\Controllers\ReportInventoryController.php
            $query = ItemWarehouse::with(['warehouse', 'item' => function ($query) {
                $query->select('id', 'barcode', 'name', 'internal_id', 'description', 'category_id', 'brand_id', 'stock_min', 'sale_unit_price', 'purchase_unit_price', 'model', 'date_of_due', 'currency_type_id');
