...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::get('items/export-digemid', 'Tenant\ItemController@exportReportDigemid');
            ...
            Route::get('documents/{id}/consultar-anulacion', [App\Http\Controllers\Tenant\DocumentController::class, 'consultarAnulacionSunat'])
            ->name('tenant.document.consultarAnulacion');
            ...
            Route::get('documents/xml-sunat/{id}', [App\Http\Controllers\Tenant\DocumentController::class, 'getXmlSunat']);
