                        ...
                        >
                            ...
                            <td class="text-left">
                                {{
                                    row.date_of_due
                                        ? (
                                            (typeof row.date_of_due === 'string'
                                                ? row.date_of_due
                                                : row.date_of_due.date
                                            ).substr(0, 10)
                                        )
                                        : ''
                                }}
    ...
    methods: {
        ...
        async enabledSearchItemBySeries(input) {
            ...
            if (this.config.search_item_by_series && this.items.length == 1) {
                if(this.items[0].lots.length > 0 && this.items[0].name !== input && this.items[0].description !== input && this.items[0].internal_id !== input) {
                    this.form.item_id = this.items[0].id;
